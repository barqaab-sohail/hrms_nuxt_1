  ...
  >
    <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
      <h2 class="font-bold text-2xl">
        BARQAAB
        <span class="bg-[#f84525] text-white px-2 rounded-md">MIS</span>
      </h2>
    </a>
    ...
    <ul class="mt-4">
      ...
      <li class="mb-1 group">
        ...
        >
          ...
          <span
            class="text-sm"
            :class="[route.name === 'dashboard' ? 'text-red-600' : '']"
            >Dashboard</span
          >
        </NuxtLink>
      </li>
