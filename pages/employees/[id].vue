              ...
              <div class="p-3">
                ...
                >
                  ...
                  <li class="flex items-center py-3">
                    ...
                    <span class="ml-auto">{{
                      employee.value.current_salary.salary
                    }}</span>
                  </li>
                  <li class="flex items-center py-3">
                    <span>Salary Effective</span>
                    <span class="ml-auto">{{
                      employee.value.current_salary.effective_date
                    }}</span>
                  </li>
                  <li class="flex items-center py-3">
                  ...
                  <li class="flex items-center py-3">
                    ...
                    <span class="ml-auto">{{
                      employee.value.hr_blood_group?.name
                    }}</span>
                  </li>
                  <li class="flex items-center py-3">
                    <span>Contact No</span>
                    <span class="ml-auto">{{
                      employee.value.hr_contact_mobile?.mobile
                    }}</span>
                  </li>
                  <li class="flex items-center py-3">
